...
part 'extended_nested_scroll_view_plus_part.dart';
...
/// to expand.
///
/// [ExtendedNestedScrollViewPlus] solves this problem by providing custom
...
///
/// {@tool dartpad}
/// This example shows a [ExtendedNestedScrollViewPlus] whose header is the combination of a
...
/// {@end-tool}
///
/// ## [SliverAppBar]s with [ExtendedNestedScrollViewPlus]s
///
/// Using a [SliverAppBar] in the outer scroll view, or [headerSliverBuilder],
/// of a [ExtendedNestedScrollViewPlus] may require special configurations in order to work
/// as it would if the outer and inner were one single scroll view, like a
/// [CustomScrollView].
///
/// ### Pinned [SliverAppBar]s
///
/// A pinned [SliverAppBar] works in a [ExtendedNestedScrollViewPlus] exactly as it would in
...
///
/// This works naturally in a [ExtendedNestedScrollViewPlus], as the pinned [SliverAppBar]
...
///
/// In order to float the outer, use [ExtendedNestedScrollViewPlus.floatHeaderSlivers]. When
...
///
/// {@tool dartpad}
/// This simple example shows a [ExtendedNestedScrollViewPlus] whose header contains a
...
///
/// It is possible with a [ExtendedNestedScrollViewPlus] to perform just the snapping
/// animation without floating the app bar in and out. By not using the
/// [ExtendedNestedScrollViewPlus.floatHeaderSlivers], the app bar will snap in and out
/// without floating.
///
...
/// implemented in a [ExtendedNestedScrollViewPlus]. These widgets take any overlapping
...
/// e.g [ExtendedNestedScrollViewPlus.floatHeaderSlivers], the [SliverAppBar] will animate
...
/// Currently, [ExtendedNestedScrollViewPlus] does not support simultaneously floating and
...
/// Currently, [ExtendedNestedScrollViewPlus] does not support stretching the outer
...
class ExtendedNestedScrollViewPlus extends StatefulWidget {
  /// Creates a nested scroll view.
  ///
  /// The [reverse], [headerSliverBuilder], and [body] arguments must not be
  /// null.
  const ExtendedNestedScrollViewPlus({
    super.key,
    this.controller,
  ...
  /// inner scroll view is not directly configured by the [ExtendedNestedScrollViewPlus],
  ...
  /// is not directly configured by the [ExtendedNestedScrollViewPlus]. For both to scroll
  ...
  /// NestedScrollView.
  ///
  /// The [ScrollPhysics] also determine whether or not the [ExtendedNestedScrollViewPlus]
  ...
  /// The widget to show inside the [ExtendedNestedScrollViewPlus].
  ///
  /// Typically this will be [TabBarView].
  ///
  /// The [body] is built in a context that provides a [PrimaryScrollController]
  /// that interacts with the [ExtendedNestedScrollViewPlus]'s scroll controller. Any
  /// [ListView] or other [Scrollable]-based widget inside the [body] that is
  /// intended to scroll with the [ExtendedNestedScrollViewPlus] should therefore not be
  /// given an explicit [ScrollController], instead allowing it to default to
  /// the [PrimaryScrollController] provided by the [ExtendedNestedScrollViewPlus].
  final Widget body;

  /// {@macro flutter.widgets.scrollable.dragStartBehavior}
  final DragStartBehavior dragStartBehavior;

  /// Whether or not the [ExtendedNestedScrollViewPlus]'s coordinator should prioritize the
  ...
  ///
  /// For sample code showing how to use this method, see the [ExtendedNestedScrollViewPlus]
  /// documentation.
  ...
  @override
  ExtendedNestedScrollViewPlusState createState() =>
      ExtendedNestedScrollViewPlusState();
}

/// The [State] for a [ExtendedNestedScrollViewPlus].
///
/// The [ScrollController]s, [innerController] and [outerController], of the
/// [ExtendedNestedScrollViewPlus]'s children may be accessed through its state. This is
/// useful for obtaining respective scroll positions in the [ExtendedNestedScrollViewPlus].
///
/// If you want to access the inner or outer scroll controller of a
/// [ExtendedNestedScrollViewPlus], you can get its [ExtendedNestedScrollViewPlusState] by supplying a
/// `GlobalKey<NestedScrollViewState>` to the [ExtendedNestedScrollViewPlus.key] parameter).
///
/// {@tool dartpad}
/// [ExtendedNestedScrollViewPlusState] can be obtained using a [GlobalKey].
...
/// {@end-tool}
class ExtendedNestedScrollViewPlusState
    extends State<ExtendedNestedScrollViewPlus> {
  final SliverOverlapAbsorberHandle _absorberHandle =
      SliverOverlapAbsorberHandle();

  /// The [ScrollController] provided to the [ScrollView] in
  /// [ExtendedNestedScrollViewPlus.body].
  ///
  ...
  ///    sliver(s) contained in [ExtendedNestedScrollViewPlus.headerSliverBuilder].
  ScrollController get innerController => _coordinator!._innerController;

  /// The [ScrollController] provided to the [ScrollView] in
  /// [ExtendedNestedScrollViewPlus.headerSliverBuilder].
  ///
  /// This is equivalent to [ExtendedNestedScrollViewPlus.controller], if provided.
  ///
  ...
  ///    [ScrollView] contained in [ExtendedNestedScrollViewPlus.body].
  ...
  @override
  void didUpdateWidget(ExtendedNestedScrollViewPlus oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.physics?.runtimeType ==
        const NeverScrollableScrollPhysics().runtimeType) {
      scrollPhysics = widget.physics;
    } else {
      scrollPhysics = widget.physics?.applyTo(const ClampingScrollPhysics()) ??
...
class _InheritedNestedScrollView extends InheritedWidget {
  ...
  final ExtendedNestedScrollViewPlusState state;
...
class _NestedScrollCoordinator
  ...
  _NestedScrollCoordinator(
    ...
    _innerController = _NestedScrollController(
      this,
      debugLabel: 'inner',
      onInnerScroll: _onInnerScroll,
    );
    _onResetPositions = () {
      return shouldResetOffsetToZero;
    };
  }
  final void Function(List<ScrollPosition>)? _onInnerScroll;
  bool shouldResetOffsetToZero = false;
  bool Function()? _onResetPositions;
  final ExtendedNestedScrollViewPlusState _state;
  ...
  Future<void> animateTo(
    ...
    if (to == 0) {
      shouldResetOffsetToZero = true;
    } else {
      shouldResetOffsetToZero = false;
    }
  ...
  void pointerScroll(double delta) {
    ...
    _onInnerScroll?.call(_innerPositions.toList());
    goBallistic(0.0);
  }
